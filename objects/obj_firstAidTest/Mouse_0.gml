...
if(!selected)
{
	...
	stringResult = "Você tirou " + testResult + " no teste de Primeiros Socorros\n";
	...
	for(var i = 0; i < array_length(obj_chapter1Controller.firstAidTestsPositions); i++)
	{
		if(obj_dialog.text_current == obj_chapter1Controller.firstAidTestsPositions[i])
		{
			obj_chapter1Controller.firstAidTestsResults[i] = passed;
			break;
		}
	}
